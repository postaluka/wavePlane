  ...
  "../../../../../../node_modules/seed-random/index.js"(exports, module) {
    ...
    function ARC4(key) {
      ...
      (me.g = function(count) {
        ...
        while (count--) {
          t2 = s2[i2 = mask & i2 + 1];
          r2 = r2 * width + s2[mask & (s2[i2] = s2[j2 = mask & j2 + t2]) + (s2[j2] = t2)];
        }
        me.i = i2;
        me.j = j2;
        return r2;
...
var require_math = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/math.js"(exports, module) {
    ...
    function lerpFrames(values, t, out) {
      ...
      var b2 = values[nextFrame % values.length];
      if (typeof a === "number" && typeof b2 === "number") {
        return lerp(a, b2, fract2);
      } else if (Array.isArray(a) && Array.isArray(b2)) {
        return lerpArray(a, b2, fract2, out);
      } else {
    ...
    function damp(a, b2, lambda, dt) {
      return lerp(a, b2, 1 - Math.exp(-lambda * dt));
    }
    function dampArray(a, b2, lambda, dt, out) {
      out = out || [];
      for (var i = 0; i < a.length; i++) {
        out[i] = damp(a[i], b2[i], lambda, dt);
      }
      return out;
    }
...
var require_convert_length = __commonJS({
  "../../../../../../node_modules/convert-length/convert-length.js"(exports, module) {
    var defined = require_defined();
...
var init_path = __esm({
  "../../../../../../node_modules/d3-path/src/path.js"() {
    ...
    Path.prototype = path.prototype = {
      ...
      arc: function(x, y, r2, a0, a1, ccw) {
        x = +x, y = +y, r2 = +r2, ccw = !!ccw;
        var dx = r2 * Math.cos(a0), dy = r2 * Math.sin(a0), x0 = x + dx, y0 = y + dy, cw = 1 ^ ccw, da = ccw ? a0 - a1 : a1 - a0;
        if (r2 < 0)
          throw new Error("negative radius: " + r2);
        if (this._x1 === null) {
          this._ += "M" + x0 + "," + y0;
        ...
        if (da < 0)
          da = da % tau + tau;
        if (da > tauEpsilon) {
          this._ += "A" + r2 + "," + r2 + ",0,1," + cw + "," + (x - dx) + "," + (y - dy) + "A" + r2 + "," + r2 + ",0,1," + cw + "," + (this._x1 = x0) + "," + (this._y1 = y0);
        } else if (da > epsilon) {
          this._ += "A" + r2 + "," + r2 + ",0," + +(da >= pi) + "," + cw + "," + (this._x1 = x + r2 * Math.cos(a1)) + "," + (this._y1 = y + r2 * Math.sin(a1));
        }
      },
...
var require_function = __commonJS({
  "../../../../../../node_modules/adaptive-bezier-curve/function.js"(exports, module) {
...
var require_adaptive_bezier_curve = __commonJS({
  "../../../../../../node_modules/adaptive-bezier-curve/index.js"(exports, module) {
    module.exports = require_function()();
  }
});
...
// ../../../../../../node_modules/svg-path-contours/node_modules/normalize-svg-path/index.js
var require_normalize_svg_path = __commonJS({
  "../../../../../../node_modules/svg-path-contours/node_modules/normalize-svg-path/index.js"(exports, module) {
    var π = Math.PI;
...
var require_vec2_copy = __commonJS({
  "../../../../../../node_modules/vec2-copy/index.js"(exports, module) {
...
var require_svg_path_contours = __commonJS({
  "../../../../../../node_modules/svg-path-contours/index.js"(exports, module) {
    var bezier = require_adaptive_bezier_curve();
    var abs = require_abs_svg_path();
    var norm = require_normalize_svg_path();
    var copy = require_vec2_copy();
...
var require_vec2 = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/vec2.js"(exports, module) {
...
// ../../../../../../node_modules/canvas-sketch-util/lib/optimize-penplot-paths.js
var require_optimize_penplot_paths = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/optimize-penplot-paths.js"(exports, module) {
    var clone = require_clone();
    var squaredDistance = require_vec2().squaredDistance;
    module.exports.sort = function sort(paths) {
      ...
      while (paths.length) {
        ...
        var result = paths.reduce(function(closest, path2, i) {
          var firstPt = path2[0];
          var lastPt = path2[path2.length - 1];
...
var require_lineclip = __commonJS({
  "../../../../../../node_modules/lineclip/index.js"(exports, module) {
    ...
    function lineclip(points, bbox, result) {
      var len = points.length, codeA = bitCode(points[0], bbox), part = [], i, a, b2, codeB, lastCode;
      if (!result)
        result = [];
      for (i = 1; i < len; i++) {
        a = points[i - 1];
    ...
    function intersect(a, b2, edge, bbox) {
      return edge & 8 ? [a[0] + (b2[0] - a[0]) * (bbox[3] - a[1]) / (b2[1] - a[1]), bbox[3]] : (
        // top
        edge & 4 ? [a[0] + (b2[0] - a[0]) * (bbox[1] - a[1]) / (b2[1] - a[1]), bbox[1]] : (
          // bottom
          edge & 2 ? [bbox[2], a[1] + (b2[1] - a[1]) * (bbox[2] - a[0]) / (b2[0] - a[0])] : (
            // right
            edge & 1 ? [bbox[0], a[1] + (b2[1] - a[1]) * (bbox[0] - a[0]) / (b2[0] - a[0])] : (
              // left
              null
            )
          )
...
var require_almost_equal = __commonJS({
  "../../../../../../node_modules/almost-equal/almost_equal.js"(exports, module) {
    "use strict";
    var abs = Math.abs;
    var min = Math.min;
    function almostEqual(a, b2, absoluteError, relativeError) {
      var d = abs(a - b2);
      if (absoluteError == null)
        absoluteError = almostEqual.DBL_EPSILON;
      if (relativeError == null)
        relativeError = absoluteError;
      if (d <= absoluteError) {
        return true;
      }
      if (d <= relativeError * min(abs(a), abs(b2))) {
        return true;
      }
      return a === b2;
    }
    almostEqual.FLT_EPSILON = 11920929e-14;
    almostEqual.DBL_EPSILON = 2220446049250313e-31;
...
var require_almost_equal2 = __commonJS({
  "../../../../../../node_modules/array-almost-equal/node_modules/almost-equal/almost_equal.js"(exports, module) {
    "use strict";
    var abs = Math.abs;
    var min = Math.min;
    function almostEqual(a, b2, absoluteError, relativeError) {
...
var require_array_almost_equal = __commonJS({
  "../../../../../../node_modules/array-almost-equal/index.js"(exports, module) {
    var isArray = require_an_array();
    var almost = require_almost_equal2();
    module.exports = function(a, b2, absoluteTolerance, relativeTolerance) {
      if (!a || !b2 || !isArray(a) || !isArray(b2))
        return false;
...
var require_clip_segment_to_circle = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/clip/clip-segment-to-circle.js"(exports, module) {
    var almostEqual = require_almost_equal();
    ...
    function intersect(x1, y1, x2, y2, cx, cy, radius, hits) {
      ...
      px = closestPoint[0];
      py = closestPoint[1];
      if (almostEqual(x1, px) && almostEqual(y1, py) || almostEqual(x2, px) && almostEqual(y2, py)) {
        return false;
      } else {
        h = distance(px, py, cx, cy);
        if (h > radius) {
...
var require_clip_line_to_circle = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/clip/clip-line-to-circle.js"(exports, module) {
    var almostEqual = require_almost_equal();
    ...
    function intersectLineCircle(p0, p1, circle, circleRadius, hits) {
      ...
      var b2 = 2 * ((p1[0] - p0[0]) * (p0[0] - circle[0]) + (p1[1] - p0[1]) * (p0[1] - circle[1]));
      var c = sqr(circle[0]) + sqr(circle[1]) + sqr(p0[0]) + sqr(p0[1]) - 2 * (circle[0] * p0[0] + circle[1] * p0[1]) - sqr(circleRadius);
      var det = b2 * b2 - 4 * a * c;
      var delta;
      if (det < 0) {
        return false;
      } else if (almostEqual(det, 0)) {
        delta = -b2 / (2 * a);
        hits.push([
...
var require_geometry = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/geometry.js"(exports, module) {
    var lineclip = require_lineclip();
    var almostEqual = require_almost_equal();
    var arrayAlmostEqual = require_array_almost_equal();
    var clone = require_clone();
    var squaredDistance = require_vec2().squaredDistance;
    ...
    module.exports.removeDuplicatePoints = function(path2) {
      var newPath = [];
      var lastPoint;
      for (var i = 0; i < path2.length; i++) {
        var curPoint = path2[i];
    ...
    module.exports.removeCollinearPoints = function(path2) {
      var newPath = [];
      var remainingPoints = clone(path2);
    ...
    module.exports.clipSegmentToCircle = require_clip_segment_to_circle();
    module.exports.clipLineToCircle = require_clip_line_to_circle();
    ...
    function createHatchLines(bounds, angle, spacing, out) {
      ...
      if (spacing === 0)
        throw new Error("cannot use a spacing of zero as it will run an infinite loop!");
      var xmin = bounds[0];
      var ymin = bounds[1];
      var xmax = bounds[2];
      var ymax = bounds[3];
      ...
      var i = -r2;
      while (i <= r2) {
        var x1 = cx + i * ca + r2 * sa;
        var y1 = cy + i * sa - r2 * ca;
        var x2 = cx + i * ca - r2 * sa;
        var y2 = cy + i * sa + r2 * ca;
        i += spacing;
...
// ../../../../../../node_modules/canvas-sketch-util/penplot.js
var require_penplot = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/penplot.js"(exports, module) {
    var defined = require_defined();
    var convert = require_convert_length();
    var d3 = (init_src(), __toCommonJS(src_exports));
    var svgPathContours = require_svg_path_contours();
    var svgPathParse = require_parse_svg_path();
    var svgPathAbs = require_abs_svg_path();
    var svgPathArcs = require_normalize_svg_path2();
    var optimizer = require_optimize_penplot_paths();
    ...
    function createPath(fn) {
      ...
      if (typeof fn === "function")
        fn(path2);
      path2.lineTo = wrap(path2.lineTo);
      path2.quadraticCurveTo = wrap(path2.quadraticCurveTo);
      path2.bezierCurveTo = wrap(path2.bezierCurveTo);
      return path2;
      function wrap(fn2) {
        return function() {
          var args = Array.prototype.slice.call(arguments);
          if (path2._x1 == null && path2._y1 == null) {
            path2.moveTo(args[0], args[1]);
          }
          return fn2.apply(path2, args);
        };
      }
    }
    ...
    function pathsToSVG(inputs, opt) {
      ...
      inputs = pathsToPolylines(inputs, Object.assign({}, convertOptions, {
        curveResolution: opt.curveResolution || void 0
      }));
      if (opt.optimize) {
        ...
        if (shouldSort)
          inputs = optimizer.sort(inputs);
        if (shouldMerge) {
          var mergeThreshold = optimizeOpts.mergeThreshold != null ? optimizeOpts.mergeThreshold : convert(0.25, "mm", units, {
            pixelsPerInch: DEFAULT_PIXELS_PER_INCH
          });
    ...
    function renderPaths(inputs, opt) {
      ...
      if (!context)
        throw new Error('Must specify "context" options');
      var units = opt.units || "px";
      var width = opt.width;
      var height = opt.height;
...
var require_regl = __commonJS({
  "../../../../../../node_modules/regl/dist/regl.js"(exports, module) {
    (function(global2, factory) {
      ...
      function unbox(x, path2) {
        if (typeof x === "function") {
          return new DynamicVariable(DYN_FUNC, x);
        } else if (typeof x === "number" || typeof x === "boolean") {
          return new DynamicVariable(DYN_CONSTANT, x);
        } else if (Array.isArray(x)) {
          return new DynamicVariable(DYN_ARRAY, x.map((y, i) => unbox(y, path2 + "[" + i + "]")));
      ...
      function createTextureSet(gl, extensions, limits, reglPoll, contextState, stats2, config) {
        ...
        function createTexture2D(a, b2) {
          var texture = new REGLTexture(GL_TEXTURE_2D$1);
          textureSet[texture.id] = texture;
          stats2.textureCount++;
          function reglTexture2D(a2, b3) {
            var texInfo = texture.texInfo;
            TexInfo.call(texInfo);
            var mipData = allocMipMap();
            if (typeof a2 === "number") {
              if (typeof b3 === "number") {
                parseMipMapFromShape(mipData, a2 | 0, b3 | 0);
              } else {
      ...
      var wrapRenderbuffers = function(gl, extensions, limits, stats2, config) {
        ...
        function createRenderbuffer(a, b2) {
          var renderbuffer = new REGLRenderbuffer(gl.createRenderbuffer());
          renderbufferSet[renderbuffer.id] = renderbuffer;
          stats2.renderbufferCount++;
          function reglRenderbuffer(a2, b3) {
            var w = 0;
            var h = 0;
      ...
      function sortState(state) {
        return state.sort(function(a, b2) {
          if (a === S_VIEWPORT) {
            return -1;
...
// ../../../../../../node_modules/primitive-quad/index.js
var require_primitive_quad = __commonJS({
  "../../../../../../node_modules/primitive-quad/index.js"(exports, module) {
...
var require_color_convert = __commonJS({
  "../../../../../../node_modules/color-convert/index.js"(exports, module) {
    ...
    for (func in conversions) {
      convert[func + "Raw"] = function(func2) {
        return function(arg) {
      ...
      convert[from][to] = convert[func] = function(func2) {
        return function(arg) {
          if (typeof arg == "number")
            arg = Array.prototype.slice.call(arguments);
...
var require_parse_color = __commonJS({
  "../../../../../../node_modules/parse-color/index.js"(exports, module) {
    ...
    module.exports = function(cstr) {
      ...
      if (res.rgb)
        res.hex = "#" + res.rgb.map(function(x) {
          var s = x.toString(16);
          if (s.length === 1)
            return "0" + s;
          return s;
      ...
      if (res.rgb)
        res.rgba = res.rgb.concat(alpha);
      if (res.hsl)
        res.hsla = res.hsl.concat(alpha);
      if (res.hsv)
        res.hsva = res.hsv.concat(alpha);
      if (res.cmyk)
        res.cmyka = res.cmyk.concat(alpha);
      return res;
    };
  }
});

// ../../../../../../node_modules/canvas-sketch-util/shader.js
var require_shader = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/shader.js"(exports, module) {
    var createRegl = require_regl();
    var createQuad = require_primitive_quad();
    ...
    function createShader(opt) {
      ...
      if (typeof opt.extensions !== "undefined")
        reglOpts.extensions = opt.extensions;
      if (typeof opt.optionalExtensions !== "undefined")
        reglOpts.optionalExtensions = opt.optionalExtensions;
      if (typeof opt.profile !== "undefined")
        reglOpts.profile = opt.profile;
      if (typeof opt.onDone !== "undefined")
        reglOpts.onDone = opt.onDone;
...
var require_float_rgb2hsl = __commonJS({
  "../../../../../../node_modules/float-rgb2hsl/index.js"(exports, module) {
    ...
    function rgb2hsl(rgb) {
      var r2 = rgb[0], g2 = rgb[1], b2 = rgb[2], min = Math.min(r2, g2, b2), max = Math.max(r2, g2, b2), delta = max - min, h, s, l;
      if (max === min) {
        h = 0;
      } else if (r2 === max) {
        h = (g2 - b2) / delta;
...
var require_rgba_to_hex = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/rgba-to-hex.js"(exports, module) {
    ...
    function rgbaToHex(rgba) {
      ...
      var b2 = Math.max(0, Math.min(255, Math.round(rgba[2] || 0)));
      var alpha = rgba[3];
      ...
      var result = (b2 | g2 << 8 | r2 << 16 | 1 << 24).toString(16).slice(1) + alphaParam;
      return "#" + result;
    }
  }
});
...
var require_relative_luminance = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/lib/relative-luminance.js"(exports, module) {
    ...
    function relativeLuminance(rgb) {
      ...
      var b2 = bsrgb <= 0.03928 ? bsrgb * lowc : adjustGamma(bsrgb);
      return r2 * rc + g2 * gc + b2 * bc;
    }
  }
});
...
var require_color = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/color.js"(exports, module) {
    ...
    module.exports.contrastRatio = function contrastRatio(colorA, colorB) {
      ...
      var b2 = module.exports.relativeLuminance(colorB);
      if (a == null || b2 == null)
        return null;
      var l1 = Math.max(a, b2);
      var l2 = Math.min(a, b2);
...
// ../../../../../../node_modules/canvas-sketch-util/index.js
var require_canvas_sketch_util = __commonJS({
  "../../../../../../node_modules/canvas-sketch-util/index.js"(exports, module) {
    module.exports = {
      random: require_random(),
      math: require_math(),
      penplot: require_penplot(),
...
export default require_canvas_sketch_util();
//# sourceMappingURL=canvas-sketch-util.js.map
